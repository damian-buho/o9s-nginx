...
- [Задачі на GitHub](https://github.com/damian-buho/o9s-nginx/issues)
...
4. **Середовище** — операційна система, версія O9S / Nginx, версія середовища виконання.
...
Платна підтримка для O9S / Nginx доступна:
